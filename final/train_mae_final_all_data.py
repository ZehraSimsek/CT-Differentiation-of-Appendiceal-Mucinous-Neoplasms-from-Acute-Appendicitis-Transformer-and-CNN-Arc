...
Çıktı: experiments_q1_128/mae_tinytransformer_final/
"""
import sys, os
...
# Model tanımını mevcut script'ten al
...
BASE_DIR = DATA_ROOT / "segformer" / "experiments_q1_128" / "mae_tinytransformer_final"
...
def main():
    ...
    # Stratified train/val split (model seçimi için)
    ...
    pd.DataFrame(rows).to_csv(test_dir / "q1_external_test_metrics.csv", index=False)
