...
TEST_CSV = Path("datas") / "external_test_set.csv"
...
def main():
    ...
    model_predictions = {}  # {m_name: {"probs": {pid: prob}, "threshold": float}}
    for m_name, folder in MODEL_DIRS.items():
        ...
        print(f"  {m_name}: threshold={threshold:.3f}, {len(pid_probs)} hasta yüklendi")
