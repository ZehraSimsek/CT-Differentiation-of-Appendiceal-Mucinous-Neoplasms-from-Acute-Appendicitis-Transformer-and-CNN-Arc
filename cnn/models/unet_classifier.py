...
class SEBlock3D(nn.Module):
    ...
    def __init__(self, in_channels, reduction=4):
        ...
        # Handle cases where in_channels // reduction == 0
...
class UNetClassifier3D(nn.Module):
    def __init__(self, in_channels: int = 1, num_classes: int = 2, dropout_rate: float = 0.4):
        ...
        # Dense skip connection mimicking UNet++: concatenate earlier features if they were the same size
        # We will simulate the dense block nature by concatenating downsampled features
