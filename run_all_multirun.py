...
# ============================================================
# SABITLER — Tüm modeller için aynı
# ============================================================
N_RUNS    = 3
...
# ============================================================
# ORTAK TEK-FOLD EĞİTİM 
# Her model için aynı döngü — builder ve config dışarıdan gelir
# ============================================================
def run_one_fold_clean(train_df, val_df, fold_idx, config, fold_dir, builder, model_tag):
    ...
    # SwinUNETR-LP: pretrained backbone yükle
    if hasattr(model, "_load_pretrained"):
        model._load_pretrained()

    # Optimizer: LP ise sadece head parametreleri
...
# ============================================================
# MULTI-RUN EĞİTİMİ — Genel fonksiyon, her model çağırır
# ============================================================
...
def main():
    ...
    # ----------------------------------------------------------
    # MODEL 1: SwinUNETR Linear Probe
    # ----------------------------------------------------------
    ...
    # SwinUNETR-LP: pretrained backbone yükleme
    ...
    # ----------------------------------------------------------
    # MODEL 2: Attention-SwinUNETR (AG-MSF)
    # ----------------------------------------------------------
    ...
    # ----------------------------------------------------------
    # MODEL 3: MAE-TinyTransformer3D (pretrain dahil)
    # ----------------------------------------------------------
